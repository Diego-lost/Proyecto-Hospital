...
export default function AgendarCitaHero({
  title = 'Agendar cita',
  subtitle = 'Envía tus datos y te confirmamos disponibilidad. También puedes llamar o escribir por correo.',
}: Props) {
  return (
    <div className="cita-hero relative overflow-hidden bg-primary text-white">
      <div
      ...
      <div className="relative mx-auto max-w-4xl px-4 py-10 md:px-6 md:py-14">
        ...
        <h1 className="font-display text-3xl font-bold tracking-tight md:text-4xl lg:text-[2.5rem]">{title}</h1>
        <p className="mt-3 max-w-2xl text-base leading-relaxed text-white/80 md:text-lg">{subtitle}</p>
      </div>
      <div className="cita-hero__wave" aria-hidden="true">
